          ...
          <div>
            <div class="d-flex">
              ...
              <div>
                ...
                <div :class="d.content" >
                  Penggalangan dana yang kamu trendingkan statusnya akan berubah menjadi trending selama 72 jam, dan kamu hanya bisa melakukan trending kembali setelah durasi trending berakhir.
                </div>
                <div class="d-flex">
                  <custom-button 
                    @click="closeDialog" 
